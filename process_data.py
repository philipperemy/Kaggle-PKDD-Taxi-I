...
#process the files
[lat1, long1, lat2, long2, lat_final, long_final, hours, duration, mean_speed, last_speed] = pre_process_train_data()
serialize(lat1, "lat1")
...
[lat1_t, long1_t, lat2_t, long2_t, hours_t, duration_t, mean_speed_t, last_speed_t] = pre_process_test_data()
